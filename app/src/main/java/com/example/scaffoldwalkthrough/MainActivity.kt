package com.example.scaffoldwalkthrough
...
import com.example.scaffoldwalkthrough.ui.theme.ScaffoldWalkthroughTheme
...
@Composable fun ScreenTopBar(title: String, navController: NavController)  {
    TopAppBar(
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable fun MainTopAppBar(title: String, navController: NavController) {
